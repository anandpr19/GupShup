  ...
  return selectedUser && (
    <div className={`b-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ?"max-md:hidden": ""}`}>
      <div className='pt-16 flex flex-col items-center '>
        ...
        <h1 className='px-10 text-xl font-medium mx-auto flex items-center gap-2 text-white'>{selectedUser.fullName}
